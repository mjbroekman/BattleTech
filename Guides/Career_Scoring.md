...
For the best score (in the current scoring system), the easier / more forgiving the settings, the higher your score will be. It's a bit counter-intuitive since you would expect that players would be rewarded in their score for playing at a harder difficulty level, but the current scoring system doesn't seem to take that into account.
